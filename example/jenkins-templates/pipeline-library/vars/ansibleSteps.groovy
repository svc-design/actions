    ...
    stage('Deploy Ignition Server') {
        ...
        steps {
            script {
                ...
                sh "ansible-playbook -u ${sshUser} -i inventory/cas_gfs_ignition.ini -kK playbooks/ignition-server.yml -l ${instanceName} -e 'ign_install_ver=${installVersion}' --vault-password-file .vault_pass.txt --diff"
            }
        }
    }
}
